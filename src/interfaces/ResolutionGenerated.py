...
class ResolutionGenerated(tk.Frame):
    ...
    def __init__(self, controller, num_defi, counter_values, fichier_pieces, defi_generated, fichier_plateau=plateau_path):
        ...
        self.plateau = self.load_plateau(fichier_plateau)
